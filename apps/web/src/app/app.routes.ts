    ...
    data: {
      seo: {
        ...
        alternates: [
          ...
          { hreflang: 'es', href: '/about?lang=es' },
  ...
  },
  {
    ...
    data: {
      seo: {
        ...
        ogImage: OG_IMAGE,
        alternates: [
          { hreflang: 'en', href: '/engineering?lang=en' },
          { hreflang: 'es', href: '/engineering?lang=es' },
          { hreflang: 'x-default', href: '/engineering' },
        ],
      } satisfies SeoConfig,
    },
  },
  {
    ...
    data: {
      seo: {
        ...
        ogImage: OG_IMAGE,
        alternates: [
          { hreflang: 'en', href: '/music?lang=en' },
          { hreflang: 'es', href: '/music?lang=es' },
          { hreflang: 'x-default', href: '/music' },
        ],
      } satisfies SeoConfig,
    },
  },
  {
    ...
    data: {
      seo: {
        ...
        ogImage: OG_IMAGE,
        alternates: [
          { hreflang: 'en', href: '/writing?lang=en' },
          { hreflang: 'es', href: '/writing?lang=es' },
  ...
  },
  {
    ...
    data: {
      seo: {
        ...
        ogImage: OG_IMAGE,
        alternates: [
          { hreflang: 'en', href: '/contact?lang=en' },
          { hreflang: 'es', href: '/contact?lang=es' },
